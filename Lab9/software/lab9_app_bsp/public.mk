...
# setting SOPC_SYSID_BASE_ADDRESS is 0x70
SOPC_SYSID_FLAG += --sidp=0x70
ELF_PATCH_FLAG  += --sidp 0x70

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1606501118
SOPC_SYSID_FLAG += --timestamp=1606501118
ELF_PATCH_FLAG  += --timestamp 1606501118
